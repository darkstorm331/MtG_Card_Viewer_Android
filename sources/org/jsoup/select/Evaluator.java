...
public abstract class Evaluator {
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        /* renamed from: a */
        protected final int f1a;
        /* renamed from: b */
        protected final int f2b;
        ...
        public boolean matches(Element root, Element element) {
            ...
            if (this.f1a == 0) {
                ...
                return true;
            } else if ((pos - this.f2b) * this.f1a < 0 || (pos - this.f2b) % this.f1a != 0) {
                return false;
            } else {
                return true;
            }
        ...
        public String toString() {
            if (this.f1a == 0) {
                return String.format(":%s(%d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f2b)});
            } else if (this.f2b == 0) {
                return String.format(":%s(%dn)", new Object[]{getPseudoClass(), Integer.valueOf(this.f1a)});
            } else {
                return String.format(":%s(%dn%+d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f1a), Integer.valueOf(this.f2b)});
            }
        }
    }
