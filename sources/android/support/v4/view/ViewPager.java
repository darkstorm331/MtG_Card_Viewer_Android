...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00361();
    ...
    private static final Interpolator sInterpolator = new C00372();
    ...
    private final Runnable mEndScrollRunnable = new C00383();
    ...
    static class C00361 implements Comparator<ItemInfo> {
        C00361() {
        }
    ...
    static class C00372 implements Interpolator {
        C00372() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00721());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C00721 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00721() {
            }
