...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C00531();
    ...
    private final Runnable mSetIdleRunnable = new C00542();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    /* renamed from: android.support.v4.widget.ViewDragHelper$1 */
    static class C00531 implements Interpolator {
        C00531() {
        }
    ...
    class C00542 implements Runnable {
        C00542() {
        }
